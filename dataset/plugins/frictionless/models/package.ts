...
export const FrictionlessPackage = z.object({
  ...
  resources: z
    .array(FrictionlessResource)
    .describe("Data resources in this package (required)"),
  name: z
    .string()
    .optional()
    .describe(
  ...
  homepage: z
    .string()
    .optional()
    .describe("A URL for the home page of the package"),
  version: z
    .string()
    .optional()
    .describe('Version of the package using SemVer (e.g., "1.0.0")'),
  licenses: z
    .array(FrictionlessLicense)
    .optional()
    .describe("License information"),
  contributors: z
    .array(FrictionlessContributor)
    .optional()
    .describe("List of contributors"),
  sources: z
    .array(FrictionlessSource)
    .optional()
    .describe("Data sources for this package"),
  keywords: z.array(z.string()).optional().describe("Keywords for the package"),
  created: z
    .string()
    .optional()
    .describe("Create time of the package in ISO 8601 format"),
