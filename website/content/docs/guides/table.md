...
import { validateTable } from "@fairspec/table"
...
```typescript
import { inferSchema } from "@fairspec/table"
...
### Schema Integration
Integrates seamlessly with `@fairspec/metadata` schemas, bridging Data Package field definitions with Polars data types for comprehensive validation workflows.
